...
//---------------- Fetch to get all medical items ---------
let type = 'medical';
...
fetch(`http://localhost:3030/inventory/?product_type=${type}`)
        ...
        .addEventListener('click', (event) => {
          ...
          updateProductBtn.addEventListener(
            ...
            () => {
              ...
              console.log(productQuantity > item.product_quantity);
              console.log(productQuantity < item.product_quantity);
              console.log(productPrice > item.product_price);
              console.log(productPrice < item.product_price);
              if (
  ...
  .catch((error) => {
    Swal.fire({
      icon: 'error',
      title: 'Error',
      text: `Error fetching medical items: ${error}`,
    });
  });
